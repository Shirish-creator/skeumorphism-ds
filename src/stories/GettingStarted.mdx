...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    Skeumorphism-ds is the design system/ components library for the Shopify admin. If you’re just starting out with Polaris, here’s a list of recommended resources and guidance to get you started.
  </div>
